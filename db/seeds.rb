...
[	
	...
	"Are fire extinguishers areas kept clear at all times?", 
	...
	"Are stairways equipped with non-slip thread and handrails?", 
	"Are safety threads provided on all step stools and stepladders?", 
...
[
	...
	"Are parking brakes are always set when leaving equipment.", 
	"Do employees remove or tamper with guards.", 
	"Do extra riders travel with the equipment operator (unless rider is being trained or assisting and the rider is in safe position)?", 
...
[
	...
	"Are safety glasses with side shields are worn at all times?",
...
[
	...
	"Has the electrical power and gas has been completely disconnected by the utilities companies?",
...
[
	...
	"Do employees now their responsibilities for reporting emergencies?"
].each do |question_name|
  category.questions.create!(body: question_name)
end
...
"Have walls of trenches and excavations are shored, benched or sloped to avoid cave-ins?",
...
"Are Class A extinguisers only used for ordinary combustible material fires?",
...
"Have aisles been cleaedr and unobstructed?",
...
"F Have standard operating procedures been established and are they being followed when cleaning up chemical spills?",
...
"F Is ventilation equipment provided for removal of contaminants from such operations as production grinding, buffing, spray painting, and/or vapor decreasing, and is it operating properly?",
...
"Are waste receptacles emptied before completely full?",
...
"Are ladders are not placed in front of a door unless the door is guarded, locked or blocked?",
...
"Has weather conditions been are monitored for potentially dangereous storms and a contingency plan been activated?"
].each do |question_name| 
  category.questions.create!(body: question_name)
end
...
"Where appropriate, are the railway crossing signals co-ordinated with nearby traffic control signals? Are the delays to vehicles due to train activity excessive, (ie > 50% of cycle time)?",
"Where appropriate, are the railway crossing signals co-ordinated with the train signalling system?",
...
"Is there safe clearance for walking in aisles where motorized or mechanical handling equipment is operating. F Are spilled materials cleaned up immediately?",
...
"Are only authorized and trained personnel permitted to use welding, cutting, or brazing equipment?",
"Are compressed gas cylinders regularly examined for obvious signs  for obvious signs of defects, deep rusting, orof defects, deep rusting, or leakage? ",
